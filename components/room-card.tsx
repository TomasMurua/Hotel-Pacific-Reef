  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {/* Navigation Buttons */}
        {room.images.length > 1 && !isDisabled && (
          <>
            <Button
              variant="outline"
              size="icon"
      ...
      <CardContent className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {room.amenities.slice(0, 4).map((amenity, index) => {
            const IconComponent =
              amenityIcons[amenity as keyof typeof amenityIcons] || Sparkles;
            return (
              <div
                key={index}
                className="flex items-center text-xs text-gray-600 bg-gray-100 px-2 py-1 rounded-full"
              >
          ...
          <Button
            ...
            className={`px-6 transition-opacity ${
              isDisabled
                ...
                : "hotel-gradient text-white hover:opacity-90"
            }`}
